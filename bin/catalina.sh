...
#
CONF_HOME=$(cd "$(dirname "$0")/../conf/crm"; pwd)
JAVA_OPTS="$JAVA_OPTS -Djava.awt.headless=true -Dfile.encoding=UTF-8 -server -Xms512m -Xmx1560m -XX:NewSize=256m -XX:MaxNewSize=256m -XX:PermSize=256m -XX:MaxPermSize=768m -XX:+DisableExplicitGC -Dcom.krawler.config.location="$CONF_HOME
#
